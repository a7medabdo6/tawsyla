...
import EcommerceCategoryDetail from "../pages/Ecommerce/Categories/CategoryDetail";
import EcommerceAddCategory from "../pages/Ecommerce/Categories/AddEditCategory";
import EcommerceOrders from "../pages/Ecommerce/EcommerceOrders/index";
import EcommerceOrderDetail from "../pages/Ecommerce/EcommerceOrders/EcommerceOrderDetail";
import EcommerceCustomers from "../pages/Ecommerce/EcommerceCustomers/index";
import EcommerceCoupons from "../pages/Ecommerce/EcommerceCoupons/index";
import EcommerceCouponDetail from "../pages/Ecommerce/EcommerceCoupons/EcommerceCouponDetail";
...
const authProtectedRoutes = [
  ...
  {
    path: "/apps-ecommerce-category-details/:_id",
    component: <EcommerceCategoryDetail />,
  },
  {
    path: "/apps-ecommerce-category-details",
    component: <EcommerceCategoryDetail />,
  },
  ...
  { path: "/apps-ecommerce-coupons", component: <EcommerceCoupons /> },
  {
    path: "/apps-ecommerce-coupon-details/:id",
    component: <EcommerceCouponDetail />,
  },
